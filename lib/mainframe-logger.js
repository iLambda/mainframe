...
import Log from './mainframe-log.js'
...
export default class Logger{
  ...
  make(title, loglevel='INFO') {
    ...
    // create log
    this[title] = new Log(this.mainframe, loglevel, fs.createWriteStream(`log/${title}.${loglevel.toLowerCase()}.log`))
    // return log
    return this[title]
  }
