...
export default class Commander{
  ...
  */
  ...
  register(agent, taskforce, args={}) {
    ...
    if (!(agent
          ...
          && !_.contains(this.registered, agent))) {
            return undefined
    }
    ...
    this.unicast(agent, 'register', _.assign(args, { id: id, taskforce: taskforce }))
    // log
  ...
  unregister(agent, args={}) {
    ...
    this.unicast(agent, 'unregister', _.assign(args, { id: id, taskforce: taskforce }))
    // log
  ...
  */
  ...
  promote(agent, taskforce) {
    ...
    this.unicast(agent, 'promote', { id: id, taskforce: taskforce })
    // log
